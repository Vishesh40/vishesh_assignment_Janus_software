...
const Dao = () => {
  ...
  const getUniswapTokens = async () => {
    ...
    const response = await fetch(
      `https://api.covalenthq.com/v1/${network}/xy=k/${dexName}/tokens/?quote-currency=USD&format=JSON&page-number=1&page-size=20&key=ckey_365b972513ba4021a5173c881e8`
    );
