...
const TopNav = (props) => {
    ...
    const fetchAssestsHandler = async () => {
        ...
        const response = await fetch(`https://api.covalenthq.com/v1/${chainId}/address/${address}/balances_v2/?&key=ckey_365b972513ba4021a5173c881e8`);
    ...
    const fetchTransactionHandler = async () => {
        const response = await fetch(`https://api.covalenthq.com/v1/${chainId}/address/${address}/transactions_v2/?&key=ckey_365b972513ba4021a5173c881e8`);
        const data = await response.json();
